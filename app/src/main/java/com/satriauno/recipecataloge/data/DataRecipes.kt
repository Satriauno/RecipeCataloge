...
object DataRecipes {
    ...
    get() {
        ...
        for (data in proteinBreakfast.indices) {
         val breakfast = Recipes(
             name = nameBreakfast[data],
             category = categoryBreakfast[data],
             description = descriptionBreakfast[data],
             ingredients = ingredientsBreakfast[data],
             price = numberBreakfast[data],
             instructions = instructionsBreakfast[data],
             photo = photoBreakfast[data],
             calories = caloriesBreakfast[data],
             carbo = carboBreakfast[data],
             protein = proteinBreakfast[data]
            )
            list.add(breakfast)
        }
        return list
    ...
    get() {
        val list = arrayListOf<Recipes>()
        for (data in proteinDessert.indices) {
            val dessert = Recipes(
                name = nameDessert[data],
                category = categoryDessert[data],
                description = descriptionDessert[data],
                ingredients = ingredientsDessert[data],
                instructions = instructionsDessert[data],
                price = numberDessert[data],
                photo = photoDessert[data],
                calories = caloriesDessert[data],
                carbo = carboDessert[data],
                protein = proteinDessert[data]
            )
            list.add(dessert)
        }
        return list
    ...
    val listVegetarian: ArrayList<Recipes>
        get() {
            val list = arrayListOf<Recipes>()
            for (data in proteinVegetarian.indices) {
                val vegetarian = Recipes(
